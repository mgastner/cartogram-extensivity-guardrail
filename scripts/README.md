...
- `run_all_countries.R` — For each variable, runs `extract_scaling_evidence()` per country using the `cartogram_advisor` package.

## Requirements

- R ≥ 4.1
- `cartogram_advisor/` R package (included in this repo)
